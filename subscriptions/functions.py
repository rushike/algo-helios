...
def get_context_for_plans2(user=None):
    ...
    #     plans_in_type = get_all_plans_xxx_type(plan_typ)
    #     context[plan_type_id] = {}
    #     for plan in plans_in_type:
    #         plan_id = str(plan.id)
    #         products = get_all_products_in_plan(plan)
    #         context[plan_type_id][plan_id] = list(products)
    #         pass 

    # for group_typ in user_groups:
    #     plan_group_id = str(group_typ)
    #     plans_in_group = get_all_plans_xxx_group(group_type = group_typ)
    #     context[plan_group_id] = {}
    #     for plan in plans_in_group:
    #         plan_id = str(plan.id)
    #         products = get_all_products_in_plan(plan)
    #         context[plan_group_id][plan_id] = list(products)
    #         pass 
    return context
