...
class PlanAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, 
        {
            'fields': ('plan_name', 'user_group_id', 'price_per_month', 'price_per_year' ,'entry_time', 'expiry_time','is_active')
        }),
    )
    
    list_display = ('plan_name', 'user_group_id', 'price_per_month', 'price_per_year' ,'entry_time', 'expiry_time','is_active')
    list_filter = ('plan_name', 'user_group_id', 'price_per_month', 'price_per_year' ,'entry_time', 'expiry_time','is_active')
    search_fields = ('plan_name','user_group_id')
    ordering = ('plan_name', 'user_group_id', 'price_per_month', 'price_per_year' ,'entry_time', 'expiry_time','is_active')
